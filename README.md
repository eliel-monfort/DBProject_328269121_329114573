...
Now, run the file [`DataToCommit.sql`](Stage_2/Rollback_Commit/DataToCommit.sql).  
...
Now run the file [`DataToRollback.sql`](Stage_2/Rollback_Commit/DataToRollback.sql).  
...
![Ammunition_Query_Example](Stage_3/Images/Ammunition_Query_Example.png)
...
![Insert DSD Diagram Image](Stage_3/ExternalDSD.png)
...
![ExternalERD](Stage_3/ExternalERD.png)
...
![Convert_To_Relational_Schema](Stage_3/Images/Convert_To_Relational_Schema.png)
...
![IntegratedERD](Stage_3/IntegratedERD.png)

### 📸 Integrated DSD

![IntegratedDSD](Stage_3/IntegratedDSD.png)
...
![Logistics_Equipment_Info_ViewTable](Stage_3/Images/Ammunition_Storage_Info_ViewTable.png)
...
![View1_Query1](Stage_3/Images/View1_Query1.png)
...
![View1_Query2](Stage_3/Images/View1_Query2.png)
...
![Ammunition_Storage_Info_ViewTable](Stage_3/Images/Ammunition_Storage_Info_ViewTable.png)
...
![View2_Query1](Stage_3/Images/View2_Query1.png)
...
![View2_Query2](Stage_3/Images/View2_Query2.png)
...
![System_Activity_Log_ViewTable](Stage_3/Images/System_Activity_Log_ViewTable.png)
...
![View3_Query1](Stage_3/Images/View3_Query1.png)
...
📸 **Example Output:**  
![View3_Query2](Stage_3/Images/View3_Query2.png)
...
![Warehouse Status Output](Stage_4/Images/F1.png)
...
![Mission Preparedness Output](Stage_4/Images/F2.png)
...
![Before Transfer](Stage_4/Images/P1-Before.png)

**During (with NOTICE message)**:

![During Transfer](Stage_4/Images/P1-During.png)

**After (Updated locations)**:

![After Transfer 1](Stage_4/Images/P1-After1.png)

![After Transfer 2](Stage_4/Images/P1-After2.png)
...
![Assign Vehicle Output](Stage_4/Images/P2-assign_vehicle-During.png)

**Assign Vehicle - Before**:

![Before](Stage_4/Images/P2-assign_vehicle-Before.png)

**Assign Vehicle - After**:

![After](Stage_4/Images/P2-assign_vehicle-After.png)

**Duplicate Assignment Exception**:

![Duplicate Exception](Stage_4/Images/P2-exception-Before.png)

![Exception Output](Stage_4/Images/P2-exception-output.png)
...
![Trigger Transfer Log](Stage_4/Images/P2-Trigger-During.png)
...
![Trigger Before](Stage_4/Images/P2-Trigger-Before.png)

![Trigger After](Stage_4/Images/P2-Trigger-After.png)
